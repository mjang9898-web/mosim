...
export default async function handler(req, res) {
  ...
  // A real checkout = a few create/capture calls; split payments add a few more.
  // 20 / min per IP comfortably clears that while stopping brute-force probing.
  if (enforceRateLimit(req, res, { key: 'paypal-order', limit: 20, windowMs: 60 * 1000 })) return;
