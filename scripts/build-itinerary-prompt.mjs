...
- SPICE LEVEL: the traveler's spice tolerance — match it in every meal.
- ALLERGENS / DIET / RELIGION / FOOD RESTRICTIONS: dietary, allergen, and religious restrictions plus any free-text note — every meal must respect them.
- CUISINE — DISHES THEY WANT / CUISINE NOTE: the Korean dishes they asked for; work EVERY one into a real meal slot during the week.
- These travelers are older (typically 55-80), so keep EVERY day gently paced and senior-friendly by default — at most ONE main outing per day with rest before and after it, never two outings stacked on the same day, step-free and bench-lined routes, and rest after care. Default to 2-3 slots a day; add extra rest/light days and spread the chosen experiences out so no day ever feels heavy.
