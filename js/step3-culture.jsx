...
const CULTURE_PAGES = [
  {
    ...
    label: 'Heritage',
    items: [
      { code: "gyeongbokgung", mono: "I", theme: "palace", eyebrow: "Palace", name: "Gyeongbokgung Royal Palace", meta: "Half day · with historian", image: "/assets/culture-heritage/gyeongbokgung.webp" },
      { code: "changdeokgung", mono: "II", theme: "palace", eyebrow: "Palace · UNESCO", name: "Changdeokgung Palace", meta: "3 hours · UNESCO", image: "/assets/culture-heritage/changdeokgung.webp" },
      { code: "huwon", mono: "III", theme: "garden", eyebrow: "Garden", name: "Huwon, the Secret Garden", meta: "90 minutes · timed entry", image: "/assets/culture-heritage/huwon.webp" },
      { code: "bukchon", mono: "IV", theme: "hanok", eyebrow: "Hanok village", name: "Bukchon Hanok Village", meta: "2–3 hours · walking", image: "/assets/culture-heritage/bukchon.webp" },
      { code: "jongmyo", mono: "V", theme: "shrine", eyebrow: "Shrine · UNESCO", name: "Jongmyo Shrine & Royal Rite", meta: "2 hours · UNESCO", image: "/assets/culture-heritage/jongmyo.webp" },
      { code: "bulguksa", mono: "VI", theme: "temple", eyebrow: "Temple · UNESCO", name: "Bulguksa Temple & Seokguram", meta: "Day trip · Gyeongju", image: "/assets/culture-heritage/bulguksa.webp" },
      { code: "haeinsa", mono: "VII", theme: "temple", eyebrow: "Templestay · UNESCO", name: "Haeinsa & the Tripitaka Koreana", meta: "Overnight · mountain", image: "/assets/culture-heritage/haeinsa.webp" },
      { code: "folkvillage", mono: "VIII", theme: "folk", eyebrow: "Folk village", name: "Korean Folk Village", meta: "Half day · near Seoul", image: "/assets/culture-heritage/folkvillage.webp" },
      { code: "hwaseong", mono: "IX", theme: "fortress", eyebrow: "Fortress · UNESCO", name: "Suwon Hwaseong Fortress", meta: "Half day · Suwon", image: "/assets/culture-heritage/hwaseong.webp" },
      { code: "hanbok", mono: "X", theme: "heritage", eyebrow: "Hanbok", name: "Royal Hanbok Photoshoot", meta: "2 hours · private studio", image: "/assets/culture-heritage/hanbok.webp" },
      { code: "royalcuisine", mono: "XI", theme: "heritage", eyebrow: "Court cuisine", name: "Royal Court Cuisine", meta: "2.5 hours · seated banquet", image: "/assets/culture-heritage/royalcuisine.webp" },
      { code: "nationalmuseum", mono: "XII", theme: "museum", eyebrow: "Museum", name: "National Museum of Korea", meta: "Half day · guided", image: "/assets/culture-heritage/nationalmuseum.webp" },
    ],
  },
  {
    id: 'shop',
  ...
  },
  {
    ...
    items: [
      ...
      { code: 'golf',         mono: 'XXXVI',   theme: 'sport',   eyebrow: 'Sports',    name: 'Signature Golf Course Round',        meta: 'Full day · 18 holes',            image: '/assets/culture-famous/golf-night.webp' },
      { code: "namsan-tower", mono: "XV", theme: "modern", eyebrow: "View", name: "N Seoul Tower at Sunset", meta: "Late afternoon into dusk · Seoul spread out beneath you", image: "/assets/culture-famous/namsan-tower.webp" },
      { code: "lotte", mono: "XVI", theme: "modern", eyebrow: "View", name: "Lotte World Tower Sky Deck", meta: "An hour at the top · 500 metres above the skyline", image: "/assets/culture-famous/lotte.webp" },
      { code: "hanriver-yacht", mono: "XVII", theme: "nature", eyebrow: "River", name: "A Han River Sunset Cruise", meta: "Golden hour on the water · Bridges lit one by one", image: "/assets/culture-famous/hanriver-yacht.webp" },
      { code: "dmz", mono: "XVIII", theme: "dmz", eyebrow: "History", name: "A Private DMZ Border Tour", meta: "A guided half-day · The world's last Cold War frontier", image: "/assets/culture-famous/dmz.webp" },
      { code: "kpop-concert", mono: "XIX", theme: "kpop", eyebrow: "K-pop", name: "A K-Pop Concert, Seated in Style", meta: "One unforgettable evening · The world's most-watched stage", image: "/assets/culture-famous/kpop-concert.webp" },
      { code: "nanta", mono: "XX", theme: "perform", eyebrow: "Show", name: "A Korean Drum & Rhythm Show", meta: "About 90 minutes · Non-verbal, pure rhythm", image: "/assets/culture-famous/nanta.webp" },
      { code: "hongdae", mono: "XXI", theme: "shop", eyebrow: "Nightlife", name: "An Evening in Vibrant Hongdae", meta: "An early evening stroll · Seoul's youthful, electric quarter", image: "/assets/culture-famous/hongdae.webp" },
      { code: "cheonggye", mono: "XXII", theme: "view", eyebrow: "City stream", name: "A Cheonggyecheon Evening Walk", meta: "An easy evening · A stream through downtown Seoul", image: "/assets/culture-famous/cheonggye.webp" },
      { code: "cherry", mono: "XXIII", theme: "nature", eyebrow: "Spring", name: "Cherry Blossoms in Full Bloom", meta: "Spring only · Korea's most beloved season", image: "/assets/culture-famous/cherry.webp" },
      { code: "bukhansan", mono: "XXIV", theme: "nature", eyebrow: "Mountain", name: "Bukhansan, Seoul's Mountain", meta: "A morning · Granite peaks above the city", image: "/assets/culture-famous/bukhansan.webp" },
    ],
  },
  {
    id: 'beyond',
...
const CULTURE_DETAILS = {
  gyeongbokgung: {
    hero: {
      eyebrow: "Palace",
      tagline: "Stand in the great courtyard where Korea's kings held court for five centuries, beneath the sweeping eaves of the dynasty's founding palace.",
    },
    facts: [
      ...
      { label: "Pacing", value: "Half day, unhurried · level main courtyards · benches and shade throughout" },
  ...
  changdeokgung: {
    hero: {
      eyebrow: "Palace · UNESCO",
      tagline: "Wander the one palace so at peace with its mountain that the world named it a treasure of humankind.",
    },
    facts: [
      { label: "Built", value: "1405 — the second royal palace of Joseon" },
      { label: "Highlights", value: "Injeongjeon throne hall · Nakseonjae quarters · curved palace walls" },
      { label: "Best time", value: "Autumn foliage in October–November · cherry-blossom season in April" },
      { label: "Pacing", value: "Three easy hours · soft slopes · accompanied at every turn" },
      { label: "Good to know", value: "Inscribed by UNESCO in 1997 for its harmony with the natural setting." },
    ],
    photos: [
  ...
  huwon: {
    hero: {
      eyebrow: "Garden",
      tagline: "Slip into the hidden garden once kept for royalty alone — lotus ponds, pavilions, and three-hundred-year-old trees mirrored in still water.",
    },
    facts: [
      { label: "What it is", value: "The rear garden of Changdeokgung, the private retreat of Joseon royalty" },
      { label: "Highlights", value: "Buyongji lotus pond · Juhamnu pavilion · ancient zelkova and gingko trees" },
      { label: "Best time", value: "Late October for crimson maples · June for lotus in bloom" },
      { label: "Pacing", value: "Ninety gentle minutes on a guided loop · soft forest paths · frequent rests" },
      { label: "Good to know", value: "Entry is by timed ticket only and limited each day; we reserve ahead." },
    ],
    photos: [
  ...
  bukchon: {
    hero: {
      eyebrow: "Hanok village",
      tagline: "Stroll quiet lanes of curved-tile rooftops and courtyard houses, lived in for six centuries in the heart of old Seoul.",
    },
    facts: [
      { label: "What it is", value: "A preserved residential quarter of traditional Korean hanok houses" },
      { label: "Highlights", value: "Rooftop alley views · craft studios and tea houses · quiet courtyard homes" },
      { label: "Best time", value: "Weekday mornings, when the lanes are calm and softly lit" },
      { label: "Pacing", value: "Two to three hours at an easy stroll · a few gentle hill lanes · cafés to pause in" },
      { label: "Good to know", value: "Residents still live here — we walk softly and keep voices low." },
    ],
    photos: [
  ...
  jongmyo: {
    hero: {
      eyebrow: "Shrine · UNESCO",
      tagline: "Follow the long stone spirit-path to Korea's most sacred shrine, where a 600-year royal rite is still kept to ancient court music.",
    },
    facts: [
      { label: "What it is", value: "The Confucian shrine of the Joseon kings, in use since the late 1300s" },
      { label: "Highlights", value: "The world's longest single shrine hall · the raised stone spirit-path" },
      { label: "Living ritual", value: "Jongmyo Jerye, the royal ancestral ceremony, performed each May with its own court music" },
      { label: "Pacing", value: "Two calm hours · level stone paths · a hushed, contemplative visit" },
      { label: "Good to know", value: "Both the shrine (UNESCO 1995) and its rite (UNESCO 2001) are world heritage." },
    ],
    photos: [
  ...
  bulguksa: {
    hero: {
      eyebrow: "Temple · UNESCO",
      tagline: "In Korea's thousand-year-old capital, meet the temple and the grotto Buddha that together crown the nation's golden age.",
    },
    facts: [
      { label: "What it is", value: "The crowning Buddhist temple of the Silla kingdom, near old Gyeongju" },
      { label: "Highlights", value: "The twin stone pagodas Dabotap and Seokgatap · the Seokguram grotto Buddha" },
      { label: "Best time", value: "Spring or autumn, for mild weather and color in the surrounding hills" },
      { label: "Pacing", value: "A full unhurried day · stone stairways with handrails · car to the grotto" },
      { label: "Good to know", value: "Bulguksa and Seokguram were jointly inscribed by UNESCO in 1995." },
    ],
    photos: [
      "/assets/culture-heritage/bulguksa.webp",
      "/assets/culture-heritage/bulguksa-2.webp",
      "/assets/culture-heritage/bulguksa-3.webp",
    ],
  },

  haeinsa: {
    hero: {
      eyebrow: "Templestay · UNESCO",
      tagline: "Pass a quiet night in a mountain monastery that has kept 80,000 carved scripture blocks flawless for nearly eight hundred years.",
    },
    facts: [
      { label: "What it is", value: "A working mountain temple offering an overnight templestay in Gayasan" },
      { label: "Treasure", value: "The Tripitaka Koreana — 80,000 woodblocks of Buddhist scripture, carved in the 1200s" },
      { label: "Experience", value: "Temple meal, evening bell, dawn chanting, and tea with a monk" },
      { label: "Pacing", value: "One restful overnight · simple rooms · a gentle, optional schedule" },
      { label: "Good to know", value: "The scripture depository is a UNESCO World Heritage site." },
    ],
    photos: [
  ...
  folkvillage: {
    hero: {
      eyebrow: "Folk village",
      tagline: "Step back into village life of centuries past — thatched farmhouses, blacksmiths and potters at work, and a thundering horseback show.",
    },
    facts: [
      { label: "What it is", value: "A large open-air museum re-creating a traditional Joseon-era village" },
      { label: "Highlights", value: "Period houses · live craft workshops · farmers' band, tightrope and equestrian shows" },
      { label: "Best time", value: "Daytime, in spring or autumn, to catch the outdoor performances" },
      { label: "Pacing", value: "Half day · flat earthen lanes · a shuttle and seated shows throughout" },
      { label: "Good to know", value: "About an hour from Seoul in Yongin; a favorite for first-time visitors." },
    ],
    photos: [
      "/assets/culture-heritage/folkvillage.webp",
      "/assets/culture-heritage/folkvillage-2.webp",
      "/assets/culture-heritage/folkvillage-3.webp",
    ],
  },

  hwaseong: {
    hero: {
      eyebrow: "Fortress · UNESCO",
      tagline: "Trace the elegant ramparts of a king's fortress city — an 18th-century feat of engineering wrapped around a town that lives on today.",
    },
    facts: [
      { label: "What it is", value: "A fortified city wall built by King Jeongjo to honor his father" },
      { label: "Built", value: "1794–1796, using advanced cranes and a blend of stone and brick" },
      { label: "Highlights", value: "Janganmun gate · Hwaseong Haenggung palace · archery and the wall trolley" },
      { label: "Pacing", value: "Half day · a trolley spares the climbs · level riverside and gate sections" },
      { label: "Good to know", value: "Inscribed by UNESCO in 1997; about 40 minutes south of Seoul." },
    ],
    photos: [
      "/assets/culture-heritage/hwaseong.webp",
      "/assets/culture-heritage/hwaseong-2.webp",
      "/assets/culture-heritage/hwaseong-3.webp",
    ],
  },
  ...
  hanbok: {
    hero: {
      eyebrow: "Hanbok",
      tagline: "Be dressed in the silk robes of Korean royalty and carry home a portrait taken among the palace halls.",
    },
    facts: [
      { label: "What it is", value: "A private hanbok fitting and photo session in traditional Korean dress" },
      { label: "Highlights", value: "Court-style silk robes · hair and accessories · portraits at the palace gates" },
      { label: "Best time", value: "Late-morning light, paired with a palace visit the same day" },
      { label: "Pacing", value: "Two gentle hours · seated fitting · a relaxed, attended shoot" },
      { label: "Good to know", value: "Wearing hanbok earns free entry to the royal palaces." },
    ],
    photos: [
  ...
  royalcuisine: {
    hero: {
      eyebrow: "Court cuisine",
      tagline: "Be served the jeweled, many-dish feast of the Joseon court — a cuisine safeguarded as intangible cultural heritage.",
    },
    facts: [
      { label: "What it is", value: "A restored Korean royal court banquet, dish by graceful dish" },
      { label: "Highlights", value: "Gujeolpan nine-section platter · neobiani grilled beef · seasonal delicacies" },
      { label: "Heritage", value: "Joseon royal court cuisine is a designated Important Intangible Cultural Property" },
      { label: "Pacing", value: "A leisurely two-and-a-half-hour seated dinner · soft courses · easy on the palate" },
      { label: "Good to know", value: "We note any dietary needs in advance for the kitchen." },
    ],
    photos: [
  ...
  nationalmuseum: {
    hero: {
      eyebrow: "Museum",
      tagline: "Take in ten millennia of Korea under one grand roof — from Silla gold crowns to a luminous gilt-bronze meditating Buddha.",
    },
    facts: [
      { label: "What it is", value: "Korea's national museum, among the largest in the world" },
      { label: "Highlights", value: "Silla gold crowns · the ten-story Gyeongcheonsa pagoda · the Pensive Bodhisattva" },
      { label: "Best time", value: "Any day with a private docent; cool and comfortable year-round" },
      { label: "Pacing", value: "Half day at your own pace · fully step-free · benches and elevators throughout" },
      { label: "Good to know", value: "General admission is free; we arrange a private English-speaking guide." },
    ],
    photos: [
  ...
  golf: {
    ...
    photos: [
      '/assets/culture-famous/golf-d1.webp',
      '/assets/culture-famous/golf-d2.webp',
      '/assets/culture-famous/golf-d3.webp',
      '/assets/culture-famous/golf-d4.webp',
      '/assets/culture-famous/golf-d5.webp',
      '/assets/culture-famous/golf-d6.webp',
    ],
  ...
  'namsan-tower': {
    hero: {
      eyebrow: "View",
      tagline: "Ride up to the city's signature lookout and watch Seoul glow from daylight into evening.",
    },
    facts: [
      { label: "Setting", value: "N Seoul Tower atop Namsan mountain" },
      { label: "Getting up", value: "Cable car, then lift to the observatory" },
      { label: "Pace", value: "Gentle, mostly step-free with rest points" },
      { label: "The draw", value: "360° sunset view and the famous love-lock terraces" },
      { label: "With you", value: "Companion times your visit for the golden hour" },
    ],
    photos: [
  ...
  lotte: {
    hero: {
      eyebrow: "View",
      tagline: "Glide to the summit of Korea's tallest tower for a view that reaches all the way to the mountains.",
    },
    facts: [
      { label: "Setting", value: "Seoul Sky observatory, Lotte World Tower" },
      { label: "Height", value: "Among the world's highest observation decks (around 500m)" },
      { label: "Getting up", value: "High-speed double-deck elevator, fully seated" },
      { label: "The draw", value: "Glass-floor terrace and a café in the clouds" },
      { label: "With you", value: "Concierge books a quiet, off-peak window" },
    ],
    photos: [
  ...
  'hanriver-yacht': {
    hero: {
      eyebrow: "River",
      tagline: "Drift along Seoul's great river as the bridges light one by one and the water turns to gold.",
    },
    facts: [
      { label: "Setting", value: "Han River, central Seoul" },
      { label: "Your seat", value: "Calm cruise boat with open deck seating" },
      { label: "Pace", value: "Smooth, restful and fully accessible" },
      { label: "The draw", value: "Banpo Bridge fountain and the skyline at dusk" },
      { label: "With you", value: "Companion arranges boarding and refreshments" },
    ],
    photos: [
  ...
  dmz: {
    hero: {
      eyebrow: "History",
      tagline: "Stand at the edge of a divided nation while a private guide brings the history quietly to life.",
    },
    facts: [
      { label: "Setting", value: "DMZ observatories and tunnels near the border" },
      { label: "Your guide", value: "Private, English-speaking historian" },
      { label: "Pace", value: "Seated transfer; viewpoints with railings and lifts" },
      { label: "The draw", value: "Overlook into North Korea and preserved Cold War sites" },
      { label: "With you", value: "Concierge clears permits and ID requirements" },
    ],
    photos: [
  ...
  'kpop-concert': {
    hero: {
      eyebrow: "K-pop",
      tagline: "See the global phenomenon up close from a comfortable seat with the view it deserves.",
    },
    facts: [
      { label: "Setting", value: "Major Seoul arena or stadium concert" },
      { label: "Your seat", value: "Reserved seating with clear sightlines" },
      { label: "Pace", value: "One headline evening, no standing required" },
      { label: "The draw", value: "Light sticks, fan chants and live spectacle" },
      { label: "With you", value: "Concierge secures tickets and door-to-door transfer" },
    ],
    photos: [
  ...
  nanta: {
    hero: {
      eyebrow: "Show",
      tagline: "Let thunderous Korean drumming and wordless comedy sweep you up — no language needed.",
    },
    facts: [
      { label: "Setting", value: "A dedicated performance theatre in central Seoul" },
      { label: "Your seat", value: "Reserved, climate-controlled theatre seating" },
      { label: "Language", value: "Non-verbal — enjoyable in any language" },
      { label: "The draw", value: "Percussion, energy, comedy and audience moments" },
      { label: "With you", value: "Companion handles tickets, seating and timing" },
    ],
        photos: [
  ...
  hongdae: {
    hero: {
      eyebrow: "Nightlife",
      tagline: "Soak in the energy of Seoul's most spirited quarter, with a performance and a café light at every turn.",
    },
    facts: [
      { label: "Setting", value: "Hongdae district near Hongik University" },
      { label: "The draw", value: "Street buskers, B-boy dancers and cafés" },
      { label: "Pace", value: "Easy stroll with frequent café rests" },
      { label: "Best time", value: "Early evening as the lights come up" },
      { label: "With you", value: "Companion guides the route and seating" },
    ],
    photos: [
      "/assets/culture-famous/hongdae-2.webp",
      "/assets/culture-famous/hongdae-3.webp",
      "/assets/culture-famous/hongdae.webp",
    ],
  },
  ...
  cheonggye: {
    hero: {
      eyebrow: "City stream",
      tagline: "Stroll a ribbon of water and lantern-light threading right through the heart of the city.",
    },
    facts: [
      { label: "Setting", value: "Cheonggyecheon, a restored stream in central Seoul" },
      { label: "Your walk", value: "Flat, paved, step-free path with frequent benches" },
      { label: "Best time", value: "After sunset, when the bridges and walls are lit" },
      { label: "The draw", value: "Lantern festivals, fountains and waterside art" },
      { label: "With you", value: "Companion keeps an easy pace and rests when you like" },
    ],
    photos: [
      "/assets/culture-famous/cheonggye-2.webp",
      "/assets/culture-famous/cheonggye-3.webp",
      "/assets/culture-famous/cheonggye.webp",
    ],
  },
  ...
  cherry: {
    hero: {
      eyebrow: "Spring",
      tagline: "Walk beneath clouds of pink blossom during Korea's most magical fortnight of the year.",
    },
    facts: [
      { label: "Setting", value: "Yeouido riverside, Seokchon Lake and palace grounds" },
      { label: "Best time", value: "Early-to-mid April, about two weeks" },
      { label: "Your walk", value: "Flat riverside promenades with plenty of seating" },
      { label: "The draw", value: "Blossom tunnels, festival stalls and river views" },
      { label: "With you", value: "We track the bloom forecast and time your visit" },
    ],
    photos: [
      "/assets/culture-famous/cherry-2.webp",
      "/assets/culture-famous/cherry-3.webp",
      "/assets/culture-famous/cherry.webp",
    ],
  },
  ...
  bukhansan: {
    hero: {
      eyebrow: "Mountain",
      tagline: "Breathe mountain air among the granite domes that crown Seoul — at whatever pace suits you.",
    },
    facts: [
      { label: "Setting", value: "Bukhansan National Park, on Seoul's northern edge" },
      { label: "Highlights", value: "Baegundae and Insubong granite peaks · forest temples" },
      { label: "Best time", value: "Crisp autumn foliage in October–November" },
      { label: "Pacing", value: "Gentle lower trails and temple paths — no summit needed" },
      { label: "With you", value: "Companion picks an easy, scenic route and carries everything" },
    ],
    photos: [
      "/assets/culture-famous/bukhansan-2.webp",
      "/assets/culture-famous/bukhansan-3.webp",
      "/assets/culture-famous/bukhansan.webp",
    ],
  },
